...
//
//  TorrentTrader v2.x
//      $LastChangedDate: 2011-11-19 00:28:10 +0000 (Sat, 19 Nov 2011) $
...
begin_table();
print("<tr><th class='table_head'>" . T_("USERNAME") . "</th><th class='table_head'>" . T_("REGISTERED") . "</th><th class='table_head'>" . T_("LAST_ACCESS") . "</th><th class='table_head'>" . T_("CLASS") . "</th><th class='table_head'>" . T_("COUNTRY") . "</th></tr>\n");
