...
echo("<tr><td>".T_("TEAM").": </td><td align='left'><input type='text' size='50' name='team_name' placeholder='".T_("REQUIRED_TEAMS_FIELD")."'/></td></tr>");
echo("<tr><td>".T_("TEAM_OWNER_NAME").": </td><td align='left'><input type='text' size='50' name='team_owner' placeholder='".T_("REQUIRED_TEAMS_FIELD")."'/></td></tr>");
echo("<tr><td valign='top'>".T_("DESCRIPTION").": </td><td align='left'><textarea name='team_description' cols='35' rows='5' placeholder='".T_("REQUIRED_TEAMS_FIELD")."'></textarea><br />(BBCode is allowed)</td></tr>");
echo("<tr><td>".T_("TEAM_LOGO_URL").": </td><td align='left'><input type='text' size='50' name='team_image' placeholder='".T_("REQUIRED_TEAMS_FIELD")."'/><input type='hidden' name='add' value='true' /></td></tr>");
