// Images Directory
imagesDir = "htmledit/icons/";

// CSS Directory
cssDir = "htmledit/styles/";

// Popups Directory
popupsDir = "htmledit/popups/";
...
var buttonName = new Array();
	...
	buttonName[1]  = "subscript";
	buttonName[2]  = "superscript";
	...
	buttonName[10] = "outdent";
	buttonName[11] = "indent";

// Order of available commands in toolbar two
var buttonName2 = new Array();
	buttonName2[0]  = "bold";
	buttonName2[1]  = "italic";
	buttonName2[2]  = "underline";
	buttonName2[3]  = "strikethrough";
	buttonName2[4]  = "forecolor";
	buttonName2[5]  = "backcolor";
	...
	buttonName2[16]  = "delimiter";

	
// List of available actions and their respective ID and images
var ToolbarList = {
//Name              buttonID                 buttonTitle           buttonImage                            buttonImageRollover
  "bold":           ['Bold',                 'Vastag',               imagesDir + 'bold.gif',               imagesDir + 'bold_on.gif'],
  "italic":         ['Italic',               'Dőlt',             imagesDir + 'italics.gif',            imagesDir + 'italics_on.gif'],
  "underline":      ['Underline',            'Aláhúzott',          imagesDir + 'underline.gif',          imagesDir + 'underline_on.gif'],
	"strikethrough":  ['Strikethrough',        'Áthúzott',      imagesDir + 'strikethrough.gif',      imagesDir + 'strikethrough_on.gif'],
	"seperator":      ['',                     '',                   imagesDir + 'seperator.gif',          imagesDir + 'seperator.gif'],
	"subscript":      ['Subscript',            'Alscript',          imagesDir + 'subscript.gif',          imagesDir + 'subscript_on.gif'],
	"superscript":    ['Superscript',          'Szuperscript',        imagesDir + 'superscript.gif',        imagesDir + 'superscript_on.gif'],
	"justifyleft":    ['Justifyleft',          'Balra zárás',        imagesDir + 'justify_left.gif',       imagesDir + 'justify_left_on.gif'],
	"justifycenter":  ['Justifycenter',        'Középre zárás',      imagesDir + 'justify_center.gif',     imagesDir + 'justify_center_on.gif'],
	"justifyright":   ['Justifyright',         'Jobbra zárás',       imagesDir + 'justify_right.gif',      imagesDir + 'justify_right_on.gif'],
	"unorderedlist":  ['InsertUnorderedList',  'Pontozott lista',imagesDir + 'list_unordered.gif',     imagesDir + 'list_unordered_on.gif'],
	"orderedlist":    ['InsertOrderedList',    'Számozott lista',  imagesDir + 'list_ordered.gif',       imagesDir + 'list_ordered_on.gif'],
	"outdent":        ['Outdent',              'Vissza léptetés',            imagesDir + 'indent_left.gif',        imagesDir + 'indent_left_on.gif'],
	"indent":         ['Indent',               'Előre léptetés',             imagesDir + 'indent_right.gif',       imagesDir + 'indent_right_on.gif'],
	"forecolor":      ['ForeColor',            'Betű Szín',          imagesDir + 'forecolor.gif',          imagesDir + 'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'Háttér Szín',          imagesDir + 'backcolor.gif',          imagesDir + 'backcolor_on.gif'],
	"undo":           ['Undo',                 'Undo',               imagesDir + 'undo.gif',               imagesDir + 'undo_on.gif'],
	"redo":           ['Redo',                 'Redo',               imagesDir + 'redo.gif',               imagesDir + 'redo_on.gif'],
	"inserttable":    ['InsertTable',          'Tábla beszúrása',        imagesDir + 'insert_table.gif',       imagesDir + 'insert_table_on.gif'],
	"insertimage":    ['InsertImage',          'Kép beszúrása',        imagesDir + 'insert_picture.gif',     imagesDir + 'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Link beszúrása',         imagesDir + 'insert_hyperlink.gif',   imagesDir + 'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'HTML szerkesztő',         imagesDir + 'view_source.gif',        imagesDir + 'view_source_on.gif'],
	"viewText":       ['ViewText',             'Szöveges szerkesztő',           imagesDir + 'view_text.gif',          imagesDir + 'view_text_on.gif'],
	"delimiter":     ['Delimiter',           'Elválasztó vonal',         imagesDir + 'delimiter.gif',        imagesDir + 'delimiter_on.gif'], 
	"selectfont":     ['SelectFont',           'Betű',         imagesDir + 'select_font.gif',        imagesDir + 'select_font_on.gif'],
	"selectsize":     ['SelectSize',           'Betűméret',         imagesDir + 'select_size.gif',        imagesDir + 'select_size_on.gif']
};
...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:75%;"><tr><td style="width: 6px;"></td>';
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:75%;" class="article_desc"><tr><td style="width: 6px;"></td>';
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + '; height:' + wysiwygHeight + 'px; border: 1px inset #000;" class="article_desc"><tr><td valign="top">\n'
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
	  alert ("Most HTML Módban vagy. Ez a funkció itt nem működik!");	
	}
	
	else {
	  // Delimiter
	  if (id == "Delimiter") {
		document.getElementById("wysiwyg" + n).contentWindow.document.execCommand("insertHTML", false, "<hr />");
	  }
      ...
      window.open(popupsDir + 'insert_image.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=230');
	  }
	    ...
	    window.open(popupsDir + 'about.html','popup','location=0,status=0,scrollbars=0,resizable=0,width=300,height=330');
	  }
