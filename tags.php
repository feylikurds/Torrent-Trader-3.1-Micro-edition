...
insert_tag(
   "Youtube 1",
   "Youtube link or google video.",
   "[video=<i>Paste URL</i>]",
   "[video=https://www.youtube.com/watch?v=CcTMxcHuEDE]",
   "Just copy/paste url"
);
...
insert_tag(
   "Youtube 2",
   "Youtube link or google video.",
   "[video]<i>Paste URL</i>[/video]",
   "[video]https://www.youtube.com/watch?v=I8IsYditHIc[/video]",
   "Just copy/paste url"
);
