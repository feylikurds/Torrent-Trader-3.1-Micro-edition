...
<tr>
    <td align="center"><a href="admincp.php?action=usersearch"><img src="images/admin/user_search.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("ADVANCED_USER_SEARCH"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=avatars"><img src="images/admin/avatar_log.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("AVATAR_LOG"); ?></a><br /></td>
	<td align="center"><a href="admincp.php?action=duplicatetorrents"><img src="images/admin/duplicate-torrent.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("DUPLICATES_TORRENT"); ?><br /></a></td>
    <td align="center"><a href="admincp.php?action=ipbans"><img src="images/admin/ip_block.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("BANNED_IPS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=bannedtorrents"><img src="images/admin/banned_torrents.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("BANNED_TORRENTS"); ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=blocks&amp;do=view"><img src="images/admin/blocks.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("BLOCKS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=cheats"><img src="images/admin/cheats.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("DETECT_POSS_CHEATS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=emailbans"><img src="images/admin/mail_bans.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("EMAIL_BANS"); ?></a><br /></td>
    <td align="center"><a href="faq-manage.php"><img src="images/admin/faq.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("FAQ"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=freetorrents"><img src="images/admin/free_leech.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("FREELEECH"); ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=lastcomm"><img src="images/admin/comments.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("LATEST_COMMENTS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=masspm"><img src="images/admin/mass_pm.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("MASS_PM"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=messagespy"><img src="images/admin/message_spy.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("MESSAGE_SPY"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=news&amp;do=view"><img src="images/admin/news.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("NEWS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=peers"><img src="images/admin/peer_list.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("PEERS_LIST"); ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=polls&amp;do=view"><img src="images/admin/polls.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("POLLS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=reports&amp;do=view"><img src="images/admin/report_system.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("REPORTS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=rules&amp;do=view"><img src="images/admin/rules.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("RULES"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=sitelog"><img src="images/admin/site_log.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("SITELOG"); ?></a><br /></td>
    <td align="center"><a href="teams-create.php"><img src="images/admin/teams.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("TEAMS"); ?></a><br /></td>
</tr>
<tr> 
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=style"><img src="images/admin/themes.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("THEME_MANAGEMENT"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=categories&amp;do=view"><img src="images/admin/torrent_cats.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("TORRENT_CAT_VIEW"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=torrentlangs&amp;do=view"><img src="images/admin/torrent_lang.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("TORRENT_LANG"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=torrentmanage"><img src="images/admin/torrents.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("TORRENTS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=groups&amp;do=view"><img src="images/admin/user_groups.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("USER_GROUPS_VIEW"); ?></a><br /></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=warned"><img src="images/admin/warned_user.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("WARNED_USERS"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=whoswhere"><img src="images/admin/whos_where.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("WHOS_WHERE"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=censor"><img src="images/admin/word_censor.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("WORD_CENSOR"); ?></a><br /></td>
    <td align="center"><a href="admincp.php?action=forum"><img src="images/admin/forums.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("FORUM_MANAGEMENT"); ?><br /></a></td>
    <td align="center"><a href="admincp.php?action=users"><img src="images/admin/simple_user_search.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("SIMPLESUERSEARCH"); ?><br /></a></td>  
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=privacylevel"><img src="images/admin/privacy_level.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("PRIVACYLEVEL"); ?><br /></a></td>     
    <td align="center"><a href="admincp.php?action=pendinginvite"><img src="images/admin/pending_invited_user.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("PENDINGUSERS"); ?><br /></a></td>    
    <td align="center"><a href="admincp.php?action=invited"><img src="images/admin/invited_user.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("INVITEDUSERS"); ?><br /></a></td>    
    <td align="center"><a href="admincp.php?action=sqlerr"><img src="images/admin/sql_error.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("SQLERR"); ?><br /></a></td>  
     <td align="center"><a href="admincp.php?action=massmail"><img src="images/admin/massmail.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("MASSMAILER"); ?><br /></a></td>
...
<tr>
    ...
    <td align="center"><a href="admincp.php?action=referer"><img src="images/admin/referral.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("REFERERS"); ?><br /></a></td>  
	<td align="center"><a href="jw-addcinema.php"><img src="images/admin/movie-icon.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("JWCINEMAVIDEOS"); ?><br /></a></td> 
    <td align="center"><a href="admincp.php?action=duplicateips"><img src="images/admin/double-ip.ico" border="0" width="118" height="80" alt="" /><br /><?php echo T_("DUPLICATEIP"); ?><br /></a></td>  
   <td align="center"><a href="admincp.php?action=inactiveusers"><img src="images/admin/inactiveusers.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("USURSINACTIVE"); ?><br /></a></td>
   <td align="center"><a href="admincp.php?action=viewlogsunconnectable"><img src="images/admin/connectable.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("NOT_CONNECT"); ?><br /></a></td>
    </tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
<tr>
    <td align="center"><a href="admincp.php?action=torrentclients"><img src="images/admin/clients.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("CLIENTS"); ?><br /></a></td>
    <td align="center"><a href="admincp.php?action=uploadstats"><img src="images/admin/uploadstats.ico" border="0" width="118" height="80" alt="" /><br /><?php echo T_("UPLOAD_STATS"); ?><br /></a></td>
    <td align="center"><a href="admincp.php?action=globaltheme"><img src="images/admin/globaltheme.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("SET_ALL_USER_THEMES"); ?><br /></a></td>
    <td align="center"><a href="admincp.php?action=clearshout"><img src="images/admin/shoutclear.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("CLEAR_SHOUTBOX"); ?><br /></a></td>
	<!--    <td align="center"><a href="admincp.php?action=backups"><img src="images/admin/db_backup.png" border="0" width="118" height="80" alt="" /><br /><?php echo T_("BACKUPS"); ?></a><br /></td>-->
</tr>    
</table>
...
/////TORRENT CLIENTS////////
if ($action == "torrentclients") {
if ($CURUSER["class"]  < 6)
    show_error_msg("Error", "Access denied.");

	$res12 = SQL_Query_exec("SELECT client, peer_id FROM peers GROUP BY client");

	stdhead("Torrent clients");

begin_frame("All Clients");

	print("<br /><table class=tabla_table align=center border=0 cellspacing=0 cellpadding=5>\n");
	print("<tr><th class=table_head>Client</th><th class=table_head>Peer ID</th><th class=table_head>To ban use</th></tr>\n");

while($arr12 = mysqli_fetch_assoc($res12)) {
		$peer=$arr12['peer_id'];
		$peer=substr($peer,0,8);
		$peer2=$peer;
print("<tr><td class=table_col1>&nbsp; $arr12[client] &nbsp;</td><td class=table_col2>&nbsp; $arr12[peer_id] &nbsp;</td><td class=table_col2>&nbsp; $peer2 &nbsp;</td></tr>\n");
}
	print("</table><br />\n");
...
stdhead(T_("HEADERGLOBAL_THEME"));
// error_reporting(E_ALL);
$do = (isset($_REQUEST["do"]));

   begin_frame("".T_("SET_ALL_USER_THEMES")."");

?>
<br /><br />
<font size ='3'><center><?php echo T_("THEME_TEXT"); ?></center></font>
<br /><br />

   <form enctype="multipart/form-data" method="post" action="admincp.php">
   <input type="hidden" name="action" value="globaltheme" />
   ...
   {
     $stylesheets = (isset($stylesheets) ? $stylesheets : "");
    if ($ss_id == $CURUSER["stylesheet"]) $ss = " selected='selected'"; else $ss = "";
     $stylesheets .= "<option value='$ss_id'$ss>$ss_name</option>\n";
   }
   print("<tr><td align='center'><font size ='3'>" . T_("CHANGE_ALL_USER_THEME") . ": </font> <select name='stylesheet'>\n$stylesheets\n</select></td></tr>");
   
   ?>

   <tr><td colspan="2" align="center"><input type="submit" value="<?php echo T_("YESTHEMECHANGE");?>" /></td></tr>
   </table></form>
   ...
   if ($do == "save_settings"){
        ...
        if (is_valid_id($stylesheet))
         ...
         SQL_Query_exec("UPDATE users SET " . implode(",", $updateset) . "");
		 write_log("Global theme changed to ID $stylesheet by $CURUSER[username]");
          autolink ("admincp.php?action=globaltheme", "<b><font color='#ff0000'>Theme changed....</font></b>");
...
if ($action=="groups" && $do=="update"){
		...
		begin_frame(T_("_BTN_UPDT_"));
		 ...
		 $update=array();
		 $update[]="level='".mysqli_real_escape_string($_POST["gname"])."'";
...
if ($action=="groups" && $do=="addnew") {
	...
	$rlevel=SQL_Query_exec("SELECT * FROM groups WHERE group_id=$group_id");
	$level=mysqli_fetch_array($rlevel);
	if (!$level)
...
if ($action=="news" && $do=="takeadd"){
	$body = $_POST["body"];
	$news_id = ($_POST['newsid'] == 'system' ? 0 : $CURUSER['id']);
	if (!$body)
		autolink("admincp.php?action=news&do=add",T_("ERR_NEWS_ITEM_CAN_NOT_BE_EMPTY"),1); 

	$title = $_POST['title'];

	if (!$title)
		autolink("admincp.php?action=news&do=add",T_("ERR_NEWS_TITLE_CAN_NOT_BE_EMPTY"),1);
	...
	$news_id . ", $added, " . sqlesc($body) . ", " . sqlesc($title) . ")");

	if (mysqli_affected_rows($GLOBALS["DBconnector"]) == 1)

		autolink("admincp.php?action=news&do=view",T_("CP_NEWS_ITEM_ADDED_SUCCESS"),1);
	else
		autolink("admincp.php?action=news&do=add",T_("CP_NEWS_UNABLE_TO_ADD"),1);
}
...
if ($action=="news" && $do=="add"){
	...
	?>
	<?php echo T_("CP_NEWS_POSTED_BY"); ?>
	<?php echo $CURUSER['username']?> <input name="newsid" type="radio" value="self" checked="checked" />
	<?php echo T_("CP_NEWS_SYSTEM"); ?><input name="newsid" type="radio" value="system" />
    <?php
...
if ($action=="news" && $do=="edit"){
	...
	if (!is_valid_id($newsid))
		autolink("admincp.php?action=news&do=view",sprintf(T_("CP_NEWS_INVAILD_ITEM_ID"), $newsid),1);
                                                                                            
	$res = SQL_Query_exec("SELECT * FROM news WHERE id=$newsid");

	if (mysqli_num_rows($res) != 1)
		autolink("admincp.php?action=news&do=view", sprintf(T_("CP_NEWS_NO_ITEM_WITH_ID"), $newsid),1);
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if ($body == "")
    		autolink("admincp.php?action=news&do=add", T_("FORUMS_BODY_CANNOT_BE_EMPTY"),1);
		...
		if ($returnto != "")
			...
			autolink("admincp.php?action=news&do=view",T_("CP_NEWS_ITEM_WAS_EDITED_SUCCESS"), 1);
	} else {
...
if ($action=="news" && $do=="delete"){
	...
	autolink("admincp.php?action=news&do=view",T_("CP_NEWS_ITEM_DEL_SUCCESS"),1);
}
...
if ($action=="blocks" && $do=="view") {
    ...
    print("<table class=\"table_table\" cellspacing=\"1\" align=\"center\" width=\"100%\">".
            "<tr>".
                "<th class=\"table_head\">".T_("_BLC_DISABLED_")."</th>".
            "</tr>".
        "</table><br />".
        "<table class=\"table_table\" cellspacing=\"1\" align=\"center\" width=\"100%\">".
            "<tr>".
...
if ($action=="categories" && $do=="view"){
	...
	echo("<tr><th width='55' class='table_head'>Cat ID</th><th width='10' class='table_head'>Sort</th><th class='table_head'>Parent Cat</th><th class='table_head'>Sub Cat</th><th class='table_head'>Image</th><th width='30' class='table_head'></th></tr>");
	...
	while ($row = mysqli_fetch_array($sql)) {
		...
		print("<tr><td class='table_col2'>$id</td><td class='table_col1'>$priority</td><td class='table_col2'>$parent</td><td class='table_col1'>$name</td><td class='table_col2' align='center'>");
...
autolink("admincp.php?action=categories&do=add", "Parent Cat cannot be empty!");

		$name = $_POST['name'];
		if ($name == "")
//			show_error_msg(T_("ERROR"), "Sub cat cannot be empty!",1);
autolink("admincp.php?action=categories&do=add", "Sub Cat cannot be empty!");
...
autolink("admincp.php?action=categories&do=view", "category was edited successfully.");
...
if ($action=="categories" && $do=="delete"){
	...
	if ($_GET["sure"] == '1'){
		...
		autolink("admincp.php?action=categories&do=view", "Category Deleted OK");
...
autolink("admincp.php?action=categories&do=add", "Parent Cat cannot be empty!");
	...
	if (mysqli_affected_rows($GLOBALS["DBconnector"]) == 1)
autolink("admincp.php?action=categories&do=view", "Category was added successfully.");
...
$mess = number_format(get_row_count("messages"),0);
$read = number_format(get_row_count("messages", "WHERE unread = 'no'"));
$unread = number_format(get_row_count("messages", "WHERE unread = 'yes'"));

print("<div style='margin-top:10px' align='center'><font size='2'>Messages: <b>$mess</b> &nbsp;|&nbsp; Read: <b>$read</b> &nbsp;|&nbsp; Unread: <b>$unread</b></font</div>");
print("<br /><br />");
...
print("<tr>
<th class='table_head' align='left'><input type='checkbox' name='checkall' onclick='checkAll(this.form.id);' /></th>
<th class='table_head' align='left'>INFO</th>
<th class='table_head' align='left'>Text</th>
<th class='table_head' align='center' width='10%'>Date</th>
</tr>\n");
...
<td align='left' class='table_col1'>
Sender:&nbsp;$sender
<div style='margin-top:5px; margin-bottom:5px'>Receiver:&nbsp;$receiver</div>
Read:&nbsp;".($arr["unread"] != "yes" ? "<b><font color=limegreen>Yes</font></b>" : "<b><font color=red>No</font></b>")."
</td>
<td align='left' class='table_col1'>$msg</td>
<td align='center' class='table_col2'>$added</td>
</tr>");
}
...
if ($action == "sitelog") {
	if ($do == "del") {
		...
		stdhead();
		show_error_msg(T_("SUCCESS"), "Entries deleted", 0);
		stdfoot();
		die();
	}
...
if ($action=="backups"){
  ...
  for( $x = count($Namebk) - 1; $x >= 0; $x--)
  {
            ...
            echo ("<td><a href='".$site_config['SITEURL']."/admincp.php?action=backups&amp;do=delete&amp;filename=".$Namebk[$x].".sql'><img src='images/delete2.png'></a></td>"); // Delete
            echo ("</tr>"); // End table row
  }
  // CLOSE TABLE
  echo ("</table>");
...
#======================================================================#
# Avatar Log - Updated by BigMax (17-11-2012)
#======================================================================#
if ($action=="avatars"){
stdhead("Avatar Log");
...
print("<div style='margin-top:10px; margin-bottom:10px' align=center><font size=2>The gallery of avatars. Click on image to view owner profile.</font></div>");

list($pagertop, $pagerbottom, $limit) = pager(50, $count, 'admincp.php?action=avatars&amp;');
echo ($pagertop);

$query = "SELECT id, username, avatar FROM users WHERE enabled='yes' AND avatar !='' $limit;";
$res = SQL_Query_exec($query);

?>
<table align=center cellpadding=5>
<?php
$cols = 5; //set cols number here

while($arr = mysqli_fetch_array($res))
{
if (($cols % 5) == 0) echo "<tr>";

echo "<td class=embedded width=150><center><a href=\"account-details.php?id=".$arr['id']."\"><br>";

if (!$arr['avatar'])
echo "<img width=\"150\" src='images/default_avatar.png' alt='' /></td>";
else
echo "<img width=\"150\" src=\"".htmlspecialchars($arr["avatar"])."\" border=0 alt=".$arr['username']." title=".$arr['username']."></a></center></td>";
...
if ($action=="masspm"){
	...
	if ($_GET["send"] == '1'){
		...
		autolink("admincp.php", "Mass PM Sent");
...
#  = This one is for my aunty Angie R.I.P (08-02-2012) 
#======================================================================#
 if ($action == "settings")
 {          
     if ($do == 'save')
     ...
     <form method="post" action="admincp.php?action=settings&amp;do=save">
     ...
     <tr>
         <td>Cache Type:</td>
         <td><input type="radio" name="" value="" <?php echo ( $site_config["cache_type"] == "disk" ? 'checked="checked"' : null ); ?> /> Disk <input type="radio" name="" value="" <?php echo ( $site_config["cache_type"] == "apc" ? 'checked="checked"' : null ); ?> /> APC <input type="radio" name="" value="" <?php echo ( $site_config["cache_type"] == "memcache" ? 'checked="checked"' : null ); ?> /> Memcache</td>
     </tr>
     <tr>
         <td>Memcache Host:</td>
     ...
     <tr>
         ...
         <td><input type="radio" name="" value="" /> Yes <input type="radio" name="" value="" /> No</td>
     </tr>
     <tr>
     ...
     <tr>
         <td>TorrentTable Columns:</td>
         <td>
         <?php $columns = array('category', 'name', 'dl', 'uploader', 'comments', 'completed', 'size', 'seeders', 'leechers', 'health', 'ratio', 'external', 'wait', 'rating', 'added', 'nfo'); ?>
         </td>
     </tr>
     <tr>
...
if ($action == "reports" && $do == "view") {
      ...
      if ($_POST["mark"])
      {
          ...
          show_error_msg(T_("SUCCESS"), "Entries marked completed.", 1);
      }
      ...
      <tr>
          ...
          <option value="request" <?php echo ($_GET['type'] == "request" ? " selected='selected'" : ""); ?>>Requests</option>
      ...
      switch ( $row["type"] )
      {
          ...
          case "torrent":
            ...
            break;
			    case "request":
                $q = SQL_Query_exec("SELECT request FROM requests WHERE id = '$row[votedfor]'");
                break;
          case "comment":
      ...
      if ($row["type"] == "user")
          ...
          $link = "torrents-details.php?id=$row[votedfor]";
              ...
              $link = "reqall.php?Section=Request_Details&id=$row[votedfor]";
...
if ($action == "confirmreg")
{
    if ($do == "confirm") 
    {
        ...
        {
            if (!@count($_POST["users"])) autolink("admincp.php?action=confirmreg", "Nothing Selected....", 1); 
		...
		if ($_POST["deletechecked"]) 
            SQL_Query_exec("DELETE FROM `users` WHERE `id` IN ($ids)");
...
if ($action == "forum") {
    ...
    if ($_POST["do"] == "add_this_forumcat") {
        ...
        if ($error_ac == "") {
            ...
            if ($res)
                autolink("admincp.php?action=forum", T_("CP_FORUM_THANK_YOU_NEW_CAT"));
            else
                echo "<h4>".T_("CP_COULD_NOT_SAVE_TO_DB")."</h4>";
        }
        else
    ...
    if ($_POST["do"] == "save_edit") {
        ...
        autolink("admincp.php?action=forum", T_("CP_FORUM_UPDATE_COMPLETED"));
    }
    ...
    ?>
          ...
          <table class='table_table' a-form' align='center' border='0' width='70%' cellspacing='2' cellpadding='5'>
          <tr class='f-form'>
          <td class='table_col1' align='right' width='30%'><?php echo T_("CP_FORUM_NEW_NAME_FOR_FORUM");?>:</td>
          <td class='table_col2' align='left'><input type="text" name="changed_forum" class="option" size="35" value="<?php echo $r["name"]; ?>" /></td>
          </tr><tr class='f-form'>
          <td class='table_col1' align='right'><?php echo T_("CP_FORUM_NEW_SORT_ORDER");?>:</td>
          <td class='table_col2' align='left'><input type="text" name="changed_sort" class="option" size="35" value="<?php echo $r["sort"]; ?>" /></td>
          </tr><tr class='f-form'>
          <td class='table_col1' align='right'><?php echo T_("CP_FORUM_DESCRIPTION");?>:</td>
          <td class='table_col2' align='left'><textarea cols='60' rows='5' name='changed_forum_desc'><?php echo $r["description"]; ?></textarea></td>
          </tr><tr class='f-form'>
          <td class='table_col1' align='right'><?php echo T_("CP_FORUM_NEW_CATEGORY");?>:</td>
          <td class='table_col2' align='left'><select name='changed_forum_cat'>
    <?php
    ...
    echo "</select></td></tr>
    <tr align='right' class='f-form'><td class='table_col1'>".T_("FORUM_MIN_CLASS_READ").":</td>
    <td class='table_col2' align='left'><select name='minclassread'>";
    ...
    echo "</select></td></tr><tr class='f-form'><td class='table_col1' align='right'>".T_("FORUM_MIN_CLASS_POST").":</td>
    <td class='table_col2' align='left'><select name='minclasswrite'>";
    ...
    <td class='table_col1' align='right'><?php echo T_("FORUM_ALLOW_GUEST_READ");?>:</td><td class='table_col2' align='left'><input type="radio" name="guest_read" value="yes" <?php echo $r["guest_read"] == "yes" ? "checked='checked'" : ""?> /><?php echo T_("YES");?> <input type="radio" name="guest_read" value="no" <?php echo $r["guest_read"] != "yes" ? "checked='checked'" : ""?> /><?php echo T_("NO");?></td></tr>
    <tr class='f-form'><td colspan='2' class='table_head' align='center'><input type="submit" class="button" value="<?php echo T_("CP_FORUM_CHANGE");?>" /></td></tr>
    </table>
    </form>
    <?php
        end_frame();
...
?>
    ...
    <input type="hidden" name="id" value="<?php echo $id; ?>" />
    <?php echo T_("CP_FORUM_REALY_DEL");?> <?php echo "<b> $v[name] ".T_("CP_FORUM_WITH")." ID$v[id] ???</b>"; ?> <?php echo T_("CP_FORUM_THIS_WILL_REALLY_DEL");?>.
    <input type="submit" name="delcat" class="button" value="<?php echo T_("CP_FORUM_DELETE");?>" />
    </form>
<?php
          end_frame();
		  navmenu();
...
?>
  ...
  <input type="hidden" name="id" value="<?php echo $id; ?>" />
      <?php echo T_("CP_FORUM_REALY_DEL_CAT");?><?php echo "<b> $v[name] ".T_("CP_FORUM_WITH")." ID$v[id] ???</b>"; ?> <?php echo T_("CP_FORUM_THIS_WILL_REALLY_DEL");?>.
      <input type="submit" name="delcat" class="button" value="<?php echo T_("CP_FORUM_DELETE");?>" />
      </form>
<?php
    end_frame();
...
if ($_GET["do"] == "edit_forumcat") {
    ...
    <input type="hidden" name="id" value="<?php echo $id; ?>" />
    <table class='table_table' a-form' align='center' border='1' width='50%' cellspacing='2' cellpadding='5'>
    <tr><td class='table_col1' align='right'><?php echo T_("CP_FORUM_NEW_NAME_CAT");?>:</td><td class='table_col2' align='left'><input type="text" name="changed_forumcat" class="option" size="35" value="<?php echo $r["name"]; ?>" /></td></tr>
    <tr><td class='table_col1' align='right'><?php echo T_("CP_FORUM_NEW_SORT_ORDER");?>:</td>
    <td class='table_col2' class='col1' align='left'><input type="text" name="changed_sortcat" class="option" size="35" value="<?php echo $r["sort"]; ?>" /></td></tr>
    <tr><td class='table_head' colspan='2' align='center'><input type="submit" class="button" value="<?php echo T_("CP_FORUM_CHANGE");?>" /></td></tr>
    </table>
    </form>
    <?php
    end_frame();
...
<br /><table class='table_table' align='center' width='80%' cellspacing='0' cellpadding='4'>
<tr><th class='table_head' colspan='2' align='center'><u><b>".T_("CP_FORUM_NEW_FORUM")."</b></u></th></tr>
<tr>
<td class='table_col1' align='right'>".T_("CP_FORUM_NEW_NAME").":</td>
<td class='table_col2'><input type='text' name='new_forum_name' size='70' maxlength='30'  value='$new_forum_name' /></td>
</tr>
<tr>
<td class='table_col1' align='right'>".T_("CP_FORUM_SORT_ORDER").":</td>
<td class='table_col2'><input type='text' name='new_forum_sort' size='70' maxlength='10'  value='$new_forum_sort' /></td>
</tr>
<tr>
<td class='table_col1' align='right'>".T_("CP_FORUM_NEW_DESC").":</td>
<td class='table_col2'><textarea cols='50' rows='5' name='new_desc'>$new_desc</textarea></td>
</tr>
<tr>
<td class='table_col1' align='right'>".T_("CP_FORUM_NEW_CAT").":</td>
<td class='table_col2'><select name='new_forum_cat'>";
...
<tr>
<td class='table_col1' align='right'>".T_("FORUM_MIN_CLASS_READ").":</td>
<td class='table_col2'><select name='minclassread'>";
...
echo "</select></td></tr>
<tr>
<td class='table_col1' align='right'>".T_("FORUM_MIN_CLASS_POST").":</td>
<td class='table_col2'><select name='minclasswrite'>";
...
"<tr>
<td class='table_col1' align='right'>".T_("FORUM_ALLOW_GUEST_READ").":</td>
<td class='table_col2'><input type=\"radio\" name=\"guest_read\" value=\"yes\" checked='checked' />Yes, <input type=\"radio\" name=\"guest_read\" value=\"no\" />No</td></tr>".
"<tr>
<th class='table_head' colspan='2' align='center'>
<input type='submit' value='".T_("CP_FORUM_ADD_NEW_FORUM")."' />
...
echo "<table class='table_table' align='center' border='0' width='80%' cellspacing='0' cellpadding='4'>";
echo "<br /><tr><td colspan='7' align='center'><u><b>".T_("FORUM_CURRENT")."</b></u></td></tr>\n";
echo "<tr><th class='table_head' width='50'><font size='2'><b>".T_("ID")."</b></font></th><th class='table_head' width='100'>".T_("NAME")."</th><th class='table_head' width='180'>".T_("CP_FORUM_DESC")."</th><th class='table_head' width='15'>".T_("CP_FORUM_SORT")."</th><th class='table_head' width='80'>".T_("CP_FORUM_CATEGORY")."</th><th class='table_head' width='8'>".T_("EDIT")."</th><th class='table_head' width='8'>".T_("DEL")."</th></tr>\n";
$query = SQL_Query_exec("SELECT * FROM forum_forums ORDER BY sort, name");
$allforums = mysqli_num_rows($query);
if ($allforums == 0) {
    echo "<tr><td class='table_col1' colspan='7' align='center'>".T_("CP_FORUM_NO_FORUMS_FOUND")."</td></tr>\n";
} else {
    while($row = mysqli_fetch_array($query)) {
        foreach ($forumcat as $cat)
            ...
            echo "<tr><td class='table_col1' width='50' align='center'><font size='2'><b>".T_("ID")."($row[id])</b></font></td><td class='table_col2' width='100'> $row[name]</td><td class='table_col1'  width='120'>$row[description]</td><td class='table_col2' width='15' align='center'>$row[sort]</td><td class='table_col1' width='80'>$category</td>\n";
            echo "<td class='table_col2' width='8' align='center'><a href='admincp.php?action=forum&amp;do=edit_forum&amp;id=$row[id]'><img src='images/forum/edit.png' alt='[".T_("EDIT")."]' width='17' height='17' border='0' /></a></td>\n";
            echo "<td class='table_col1' width='8' align='center'><a href='admincp.php?action=forum&amp;do=del_forum&amp;id=$row[id]'><img src='images/forum/delete.png' alt='[".T_("CP_FORUM_DELETE_FORUM")."]' width='17' height='17' border='0' /></a></td></tr>\n";
    }
}
echo "</table><br /><br />";


echo "<form action='admincp.php?action=forum' method='post'>
<input type='hidden' name='do' value='add_this_forumcat' />
<br /><br /><table class='table_table' border='0' align='center' width='80%' cellspacing='0' cellpadding='4'>
<tr><th class='table_head' colspan='2' align='center'><u><b>".T_("CP_FORUM_NEW_CATEGORY")."</b></u></th></tr>
<tr>
<td class='table_col1' align='right'>".T_("FORUM_NAME_OF_NEW_CAT").":</td>
<td class='table_col2' class='f-form'><input type='text' name='new_forumcat_name' size='60' maxlength='30'  value='$new_forumcat_name' /></td>
</tr>
<tr>
<td class='table_col1' align='right'>".T_("FORUM_CAT_SORT_ORDER").":</td>
<td class='table_col2'><input type='text' name='new_forumcat_sort' size='60' maxlength='10'  value='$new_forumcat_sort' /></td>
</tr>
<tr>
<th class='table_head' colspan='2' align='center'>
...
echo "<table class='table_table' align='center' border='0' width='80%' cellspacing='0' cellpadding='4'>";
echo "<br /><tr><td colspan='7' align='center'><u><b>".T_("CP_FORUM_CURRENT_CATEGORYS")."</b></u></td></tr>\n";
echo "<tr><th class='table_head' align='center' width='50'><font size='2'><b>".T_("ID")."</b></font></th><th class='table_head' width='120'>".T_("NAME")."</th><th class='table_head' width='18'>".T_("CP_FORUM_SORT")."</th><th class='table_head' width='18'>".T_("EDIT")."</th><th class='table_head' width='18'>".T_("DEL")."</th></tr>\n";

if ($allcat == 0) {
    echo "<tr class='table_col1'><td class='f-border' colspan='7' align='center'>".T_("FORUM_NO_CAT_FOUND")."</td></tr>\n";
} else {
    foreach ($forumcat as $row) {
        echo "<tr><td align='center' class='table_col1' width='50'><font size='2'><b>".T_("ID")."($row[id])</b></font></td><td class='table_col2' width='120'> $row[name]</td><td class='table_col1' align='center' width='18'>$row[sort]</td>\n";
        echo "<td class='table_col2' align='center' width='18'><a href='admincp.php?action=forum&amp;do=edit_forumcat&amp;id=$row[id]'><img src='images/forum/edit.png' alt='[".T_("EDIT")."]' width='17' height='17' border='0' /></a></td>\n";
        echo "<td class='table_col1' align='center' width='18'><a href='admincp.php?action=forum&amp;do=del_forumcat&amp;id=$row[id]'><img src='images/forum/delete.png' alt='[".T_("FORUM_DELETE_CATEGORY")."]' width='17' height='17' border='0' /></a></td></tr>\n";
    }
}
echo "</table><br />\n";
...
if ($action == "massmail")
{
                if ($do == "send")
                {
                                ...
                                $res_log = SQL_Query_exec("SELECT DISTINCT level FROM groups WHERE group_id IN ($ids)");
                                while ($row_log = mysqli_fetch_assoc($res_log))
                                {          
                                        $msg_log .= $row_log["level"] . ", ";
                                }

                                $res = SQL_Query_exec("SELECT u.email FROM users u LEFT JOIN groups g ON u.class = g.group_id WHERE u.enabled = 'yes' AND u.status = 'confirmed' AND u.class IN ($ids)");
                                while ($row = mysqli_fetch_assoc($res))
                                {          
                                        sendmail($row["email"], $subject, $body, "Content-type: text/html; charset=utf-8", "-f$site_config[SITEEMAIL]");  
                                }

                               write_log("<b><font color='Magenta'>A Mass E-Mail</font> was sent by (<font color='Navy'>$CURUSER[username]</font>) $msg_log<b>");
 //                               show_error_msg("Success", "Your Mass E-mail was sent.", 1);
								autolink ("admincp.php", "<b><font color='#ff0000'>Mass mail sent....</font></b>");
                }
...
if ($action == "referer")
{
          $count = get_row_count("referer");
        
          list ($pagertop, $pagerbottom, $limit) = pager(20, $count, 'admincp.php?action=referer&amp;');
        
          $res = SQL_Query_exec("SELECT * FROM `referer` ORDER BY `added` DESC $limit");
        
          stdhead("Site Referer");
          
        
          begin_frame("Site Referer");
        
          if ( mysqli_num_rows($res) > 0 )
          {
                   ?>
                   <table class="table_table" cellpadding="3" cellspacing="3" width="75%" align="center">
                   <tr>
                           <th class="table_head">Referer</th>
                           <th class="table_head">Added</th>
                           <th class="table_head">Count</th>
                   </tr>
                   <?php while ($row = mysqli_fetch_assoc($res)): ?>
                   <tr>
                           <td class="table_col1"><a href="<?php echo $row['referer']; ?>"><?php echo $row['referer']; ?></a></td>
                           <td class="table_col2"><?php echo date('F d, Y g:i a',$row['added']); ?></td>
                           <td class="table_col1"><?php echo number_format($row['count']); ?></td>
                   </tr>
                   <?php endwhile; ?>
                   </table>
                   <?php
                  
                   if ( $count > 20 ) echo $pagerbottom;
          }
          else
          {
                   echo('<center><b>No Referrals Found...</b></center>');
          }
...
if ($_GET['action'] == "listunconnectable") {
...
begin_frame("Unconnectable");
	...
	print("<br/><a href=admincp.php?action=sendpmunconnectable>Send all not connectable users a PM</a>");
	print("<br/><a href=admincp.php?action=viewlogsunconnectable>View the Log (Check this before PMing users)</a>");
...
if ($_GET['action'] == "sendpmunconnectable") {
	stdhead("Peers that are unconnectable");
begin_frame("Send PM");
?>
...
<tr>
	...
	<form method="post" action="admincp.php?action=viewlogsunconnectable">
...
if ($_GET['action'] == "viewlogsunconnectable") {
stdhead("Unconnectable Peers Mass PM Log");
begin_frame("Unconnectable PM Logs");
$getlog = SQL_Query_exec("SELECT * FROM notconnectablepmlog LIMIT 10");
print("Unconnectable Peers Mass PM Log");
print("<br/><br/><a href=admincp.php?action=sendpmunconnectable>&nbsp;&nbsp;<b>* Send all not connectable users a PM</b></a>");
print("<br/><a href=admincp.php?action=listunconnectable>&nbsp;&nbsp;<b>* List Unconnectable Users</b></a>");
...
///////////////// CLEAR STOCK 2.08 SHOUTBOX /////////////////////////////

if ($action == "clearshout" && (!$site_config["AJSHOUTBOX"])) {
...
<br /><br />
   ...
   if ($do == "delete"){
         SQL_Query_exec("TRUNCATE TABLE `shoutbox`");
		 write_log("Shoutbox cleared by $CURUSER[username]");
		 $msg_shout = sqlesc("[color=#ff0000]".T_("SHOUTBOX_CLEARED_MESSAGE")."[/color]");
         SQL_Query_exec("INSERT INTO shoutbox (userid, date, user, message) VALUES(0,'".get_date_time()."', '".T_('SYSTEM')."' ,".$msg_shout.")");
         autolink ("admincp.php", "<b><font color='#ff0000'> Stock TT Shoutbox Cleared....</font></b>");
 
}
   navmenu();
   stdfoot();
}
///////////////END CLEAR STOCK 2.08 SHOUTBOX //////////////////////////////////////////////
///////////////// CLEAR AJAX SHOUTBOX /////////////////////////////
...
<br /><br />
   ...
   <form enctype="multipart/form-data" method="post" action="admincp.php">
   <input type="hidden" name="action" value="clearshout" />
   <input type="hidden" name="do" value="deleteajaxshoutbox" />
   <table class="f-border" cellspacing="0" cellpadding="5" width="100%" align="center">
   <tr><td colspan="2" align="center"><input type="submit" value="<?php echo T_("CLEAR_SHOUTBOX");?>" /></td></tr>
   </table></form>
   ...
   if ($do == "deleteajaxshoutbox"){
         SQL_Query_exec("TRUNCATE TABLE `ajshoutbox`");
		 write_log("AJAX Shoutbox cleared by $CURUSER[username]");
		 $msg_shout = sqlesc("[color=#ff0000]".T_("SHOUTBOX_CLEARED_MESSAGE")."[/color]");
         SQL_Query_exec("INSERT INTO ajshoutbox (uid, date, name, text) VALUES(0,'".get_date_time()."', '".T_('SYSTEM')."' ,".$msg_shout.")");
         autolink ("admincp.php", "<b><font color='#ff0000'> AJAX Shoutbox Cleared....</font></b>");
...
#  Duplicate torrents
#======================================================================#
if ($action == "duplicatetorrents")
{
    $res = SQL_Query_exec("SELECT filename FROM torrents GROUP BY filename HAVING count(*) > 1");
    $num = mysqli_num_rows($res);
    list($pagertop, $pagerbottom, $limit) = pager(25, $num, 'admincp.php?action=duplicatetorrents&amp;');
    $res = SQL_Query_exec("SELECT id, info_hash, name, leechers, seeders, filename, save_as, size, added, category, COUNT(*) as count FROM torrents GROUP BY filename HAVING count(*) > 1 ORDER BY id ASC $limit");

    stdhead(T_("DUPLICATES_TORRENT"));
    begin_frame(T_("DUPLICATES_TORRENT"));
    ?>
    <br />
    <?php if ($num > 0): ?>
    <br />
    <table border="0" cellpadding="3" cellspacing="0" width="100%" align="center" class="table_table">
    <tr>
            <th class="table_head"><?php echo T_("DUPLICATE_TORRENTS_NAME"); ?></th>
            <th class="table_head"><?php echo T_("DUPLICATE_LEACHERS"); ?></th>
            <th class="table_head"><?php echo T_("DUPLICATE_SEEDERS"); ?></th>
            <th class="table_head"><?php echo T_("DUPLICATE_COUNTS"); ?></th>
    </tr>
    <?php while ($row = mysqli_fetch_assoc($res)): ?>
    <tr>
            <td class="table_col1" align="center"><a href="torrents-details.php?id=<?php echo $row["id"]; ?>"><b><?php echo $row["name"]; ?></b></a></td>
            <td class="table_col1" align="center"><?php echo $row["leechers"]; ?></td>
            <td class="table_col2" align="center"><?php echo $row["seeders"]; ?></td>
            <td class="table_col1" align="center"><a href="torrents-search.php?search=<?php echo $row['filename']; ?>&cat=0&incldead=1"><?php echo number_format($row['count']); ?></a></td>
    </tr>
    <?php endwhile; ?>
    </table>
    <?php else: ?>
          <center><b><?php echo T_("NOTHING_FOUND"); ?></b></center><br />
    <?php
    endif;

    if ($num > 50) echo $pagerbottom;
