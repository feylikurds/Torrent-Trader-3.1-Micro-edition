...
--
-- Host: localhost
-- Generation Time: Dec 14, 2017 at 06:09 PM
...
CREATE TABLE IF NOT EXISTS `ajshoutbox` (
...
--
-- Dumping data for table `ajshoutbox`
--

INSERT INTO `ajshoutbox` (`id`, `uid`, `date`, `name`, `text`) VALUES
(1, 0, '2017-12-14 21:39:08', 'System', '[color=#ff0000]The shoutbox has been cleared[/color]');
...
CREATE TABLE IF NOT EXISTS `announce` (
  ...
  `online` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  PRIMARY KEY (`id`),
  KEY `torrent` (`torrent`)
...
CREATE TABLE IF NOT EXISTS `bans` (
  ...
  `first` varchar(39) CHARACTER SET latin1 DEFAULT NULL,
  `last` varchar(39) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `blocks` (
  ...
  `named` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `name` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `position` varchar(10) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
(1, 'donate', 'donate', 'right', 'Description here...', 0, 0),
(2, 'invite', 'invite', 'right', 'Description here...', 1, 1),
(3, 'Main Navigation', 'navigate', 'right', 'Description here...', 0, 0),
(4, 'Login Block', 'login', 'left', 'Description here...', 1, 1),
(5, 'rss', 'rss', 'right', 'rss', 0, 0),
(6, 'latestuploads', 'latestuploads', 'right', 'Description here...', 0, 0),
(37, 'advancestats', 'advancestats', 'right', '', 0, 0),
(8, 'serverload', 'serverload', 'right', 'Description here...', 1, 2),
(9, 'usersonline', 'usersonline', 'left', 'Description here...', 0, 0),
(10, 'Main Category', 'maincats', 'left', 'Description here...', 0, 0),
...
(17, 'polls', 'polls', 'left', 'Description here...', 0, 0),
(18, 'seedwanted', 'seedwanted', 'right', 'Description here...', 1, 5),
...
(22, 'imdb', 'imdb', 'left', 'IMDB search block', 1, 2),
(27, 'usersonlinetoday', 'usersonlinetoday', 'left', '', 1, 5),
(29, 'foldermonitor', 'foldermonitor', 'right', '', 0, 0),
(30, 'pornhub', 'pornhub', 'right', 'porn', 0, 0),
(31, 'porn', 'porn', 'right', '', 1, 4),
(33, 'clock-calendar', 'clock-callender', 'right', '', 0, 0),
(34, 'Google', 'Google', 'right', '', 1, 3),
(35, 'youtube', 'youtube', 'left', 'YOUTUBE', 1, 3),
...
(40, 'announcements', 'announcements', 'middle', 'PM Announcements', 1, 2),
(41, 'ajaxonlineusers', 'ajaxonlineusers', 'middle', 'AJAX Online users', 1, 1);
...
CREATE TABLE IF NOT EXISTS `browsers` (
  ...
  `browserpic` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `browsers` (`id`, `name`, `browserpic`) VALUES
(1, 'Firefox', 'firefox.png'),
(2, 'Safari', 'safari.png'),
(3, 'Opera', 'opera.png'),
(4, 'Maxthon', 'maxthon.png'),
(5, 'Konqueror', 'konqueror.png'),
(6, 'Internet Explorer', 'internet_explorer.png'),
(7, 'Google Chrome', 'google_chrome.png'),
(8, 'Netscape', 'netscape.png'),
(9, 'Unknown', 'unknown.png'),
(10, 'Edge', 'MSedge.png');
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `subcat` char(3) CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `parent_cat` varchar(15) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `sub_sort` char(3) CHARACTER SET latin1 NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
(1, 'DVD', 5, 'dvd.png', 'yes', 'Movies', '1'),
(2, 'Divx/Xvid', 1, 'xvid.png', 'yes', 'Movies', '2'),
(6, 'TV Shows', 6, 'tv.png', 'yes', 'TV', '6'),
(10, 'PC', 4, 'cat_games.png', 'yes', 'Games', '10'),
(18, 'PC', 8, 'apps.png', 'yes', 'Apps', '18'),
(22, 'MP3', 3, 'music.png', 'yes', 'Music', '22'),
(50, 'Porn', 9, 'xxx2.png', 'no', 'Porn', ''),
(52, 'Cam/TS/TC', 7, 'telesync.png', 'no', 'Movies', ''),
(53, 'Miscellaneous', 10, 'cat_misc.png', 'no', 'Miscellaneous', ''),
(54, 'R3/R5/R6', 11, 'r5.png', 'no', 'Movies', ''),
(55, 'Documentaries', 12, 'documentary.png', 'no', 'Documentary', ''),
(56, 'Screener', 2, 'screener.png', 'no', 'Movies', '');
...
CREATE TABLE IF NOT EXISTS `censor` (
  `word` varchar(25) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `censor` varchar(25) CHARACTER SET latin1 NOT NULL DEFAULT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `req` int(11),
  `ori_text` text COLLATE utf8_unicode_ci,
  `editedby` text COLLATE utf8_unicode_ci,
  `editedat` datetime,
  PRIMARY KEY (`id`),
  KEY `user` (`user`),
  KEY `torrent` (`torrent`)
...
CREATE TABLE IF NOT EXISTS `countries` (
  ...
  `flagpic` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `domain` char(3) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `email_bans` (
  ...
  `addedby` int(10) unsigned NOT NULL DEFAULT '0',
  `comment` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `mail_domain` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `forum_forums` (
  ...
  `guest_read` enum('yes','no') CHARACTER SET latin1 DEFAULT 'yes',
...
(1, 1, 'Just type something', 'type whatever you feel like', 1, 1, 'no', 1);
...
(1, 1, 1, '2017-04-02 05:41:59', 'just a test  :crazy:', 0, '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `forum_topics` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(40) CHARACTER SET latin1 DEFAULT NULL,
  `locked` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `forumid` int(10) unsigned NOT NULL DEFAULT '0',
  `lastpost` int(10) unsigned NOT NULL DEFAULT '0',
  `moved` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
...
CREATE TABLE IF NOT EXISTS `groups` (
  ...
  `level` varchar(50) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `view_torrents` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `edit_torrents` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `delete_torrents` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `view_users` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `edit_users` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `delete_users` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `view_news` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `edit_news` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `delete_news` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `can_upload` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `can_download` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `view_forum` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `edit_forum` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `delete_forum` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `control_panel` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `staff_page` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `staff_public` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
...
(7, 'Administrator', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 1),
...
CREATE TABLE IF NOT EXISTS `guests` (
  `ip` varchar(39) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
('174.59.233.84', 1513288720);

-- --------------------------------------------------------

--
-- Table structure for table `jwcinema`
--

CREATE TABLE IF NOT EXISTS `jwcinema` (
  `description` text NOT NULL,
  `poster` varchar(255) NOT NULL,
  `aviurl` varchar(100) NOT NULL DEFAULT '',
  `thumbnail` varchar(255) NOT NULL,
  `width` varchar(50) NOT NULL,
  `height` varchar(50) NOT NULL,
  `cinemaonline` enum('yes','no') NOT NULL DEFAULT 'yes',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `jwcinema`
--

INSERT INTO `jwcinema` (`description`, `poster`, `aviurl`, `thumbnail`, `width`, `height`, `cinemaonline`, `id`, `name`, `info`) VALUES
('Enter a description of this video/movie', 'http://3.bp.blogspot.com/-pdJJHZWeWUY/T_yFxbhiwxI/AAAAAAAAHAM/6AZ1gQUHLFM/s1600/Pioneer+Woman%27s+yeast+glazed+donuts3.jpg', 'https://www.youtube.com/watch?v=CW39sZY1PX0', '', '', '', 'yes', 1, 'Why do cops eat donuts?', '<b>Category</b>: example:Sci-fi <br /><b>Length</b>: example:1h 30min<br /><b>Year</b>: <br /><b>Director</b>: <br /><b>Cast</b>: ');
...
(12, '2017-12-14 21:35:42', '<b>Shout<font color=''orange''> You can also switch to the AJshoutbox in the config and all the same rules apply there</font> Deleted by: admin</b>'),
(13, '2017-12-14 21:38:59', '<B><font color=orange>Shout Deleted: </font> Deleted by   admin</b>'),
(14, '2017-12-14 21:39:08', 'AJAX Shoutbox cleared by admin'),
(15, '2017-12-14 21:59:19', 'Global theme changed to ID 2 by admin');
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `location` enum('in','out','both','draft','template') CHARACTER SET latin1 NOT NULL DEFAULT 'in',
  PRIMARY KEY (`id`),
...
(6, 0, 136, '2017-12-14 21:12:28', 'Thank you for registering at our tracker! Please seed anything you download for as long as you can :)', 'yes', 0, '', 'in');
...
(1, 0, '2017-04-02 06:35:44', 'traileraddict.com', '[url=http://www.traileraddict.com/trailerapi]click here and sign up for a API key so trailers get automatically added to your torrent details if you dont add a youtube or IMDb trailer[/url]'),
(2, 1, '2017-04-02 06:37:59', 'Site videos player', '[url=https://www.jwplayer.com/]Click here and sign up and get a key to use the player if you would like to have videos posted, like youtube, vimeo, etc.[/url]');
...
CREATE TABLE IF NOT EXISTS `peers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `torrent` int(10) unsigned NOT NULL DEFAULT '0',
  `peer_id` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `ip` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `port` smallint(5) unsigned NOT NULL DEFAULT '0',
  `uploaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `downloaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `to_go` bigint(20) unsigned NOT NULL DEFAULT '0',
  `seeder` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `started` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `last_action` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `connectable` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `client` varchar(60) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=137675 ;
...
CREATE TABLE IF NOT EXISTS `polls` (
  ...
  `option0` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option1` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option2` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option3` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option4` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option5` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option6` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option7` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option8` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option9` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option10` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option11` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option12` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option13` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option14` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option15` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option16` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option17` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option18` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `option19` varchar(40) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `sort` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
(14, 1, 4, '2012-01-17 10:12:33'),
(1093, 1, 5, '2016-02-25 03:26:13');
...
CREATE TABLE IF NOT EXISTS `referer` (
  ...
  `added` int(11) NOT NULL DEFAULT '10',
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `type` enum('torrent','user','forum','comment','other','request') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'torrent',
...
CREATE TABLE IF NOT EXISTS `rules` (
  ...
  `public` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
...
(1, 'General rules - Breaking these rules can and will get you banned!', '- We do not tolerate using this site on public computers. If you do this, YOU WILL BE BANNED AND YOUR ACCOUNT WILL BE DELETED. This is not up for discussion. Use your own private computer in any way you see fit (IE: public WiFi, Ethernet connections, etc.) Just DO NOT use a public computer to log on to this site or I will personally shit in your mouth.\r\n\r\n- Keep seeding the files you got for as long as you can. It makes it better for everyone\r\n\r\n- Do NOT just grab files, then stop seeding. If you have to turn off your machine for some reason, a REASONABLE amount of time will be allowed to pass before you should be helping seed the file. The more people on the files, the faster it is for everyone', 'yes', 0),
(2, 'General Forum Guidelines', '- No aggressive behaviour or flaming in the forums. \r\n- No trashing of other peoples topics (i.e. SPAM). \r\n- No language other than English in the forums. \r\n- No links to warez or crack sites in the forums. \r\n- No serials, CD keys, passwords or cracks in the forums. \r\n- No requesting if the release is over 7 days old. \r\n- No bumping... (All bumped threads will be deleted.) \r\n- No double posting. If you wish to post again, and yours is the last post in the thread please use the EDIT function,instead of posting a double.\r\n- Please ensure all questions are posted in the correct section!', 'no', 1),
...
CREATE TABLE IF NOT EXISTS `shoutbox` (
  ...
  `user` varchar(50) CHARACTER SET latin1 NOT NULL DEFAULT '0',
...
(3, 'admin', 'As the site owner, you are group_id 8. Config.php will require that you look at it CAREFULLY and make sure it is set the way you would like it, so go look at that file and set it accordingly', '2017-04-02 06:29:24', 1),
(4, 'admin', 'Scroll down the screen, and you will see the news area. I moved it to the bottom of the page. Read the news, I put a few things there.', '2017-04-02 06:47:34', 1),
(6, 'admin', 'This code has been tested on ubuntu 14.04.5, MySQL 5.5.54, PHP 5.5.9 and Apache 2.4.7 and will NOT work under PHP 7, so don''t even try it. I believe I corrected all open PHP tags, but I may have missed one, so if you have a problem seeing code on your screen, edit your php.ini and set short_open_tags to ON', '2017-04-02 07:00:51', 1),
(7, 'admin', 'site videos will NOT work until you get a key from JWPLAYER.', '2017-04-02 07:19:44', 1),
(9, 'admin', 'openSSL is also required, as this site is set to secure torrent downloads. Make sure openSSL is installed on your linux server. If you run windows server, I cant and wont help you, but you can reverse the edits in torrents-details.php, and in functions.php. The original code is commented', '2017-04-02 19:10:37', 1),
(10, 'admin', 'when you are done editing and you feel happy with all of your edits, you can clear this shoutbox in the Staff CP. You can also edit or delete shoutbox messages. Users with a group ID of 6 or higher can also delete and edit shouts (super moderator, admin, and site owner). This can be changed in the shoutedit.php file', '2017-04-08 00:14:44', 1);
...
(2, 'NB-H20-3c', 'White-Narrow Skin'),
(1, 'NB-41', 'NB-41 Orange');
...
CREATE TABLE IF NOT EXISTS `tasks` (
  `task` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `torrents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `info_hash` varchar(40) CHARACTER SET latin1 DEFAULT NULL,
  `name` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `filename` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `save_as` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  ...
  `added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `type` enum('single','multi') CHARACTER SET latin1 NOT NULL DEFAULT 'single',
  ...
  `banned` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `owner` int(10) unsigned NOT NULL DEFAULT '0',
  `anon` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `numratings` int(10) unsigned NOT NULL DEFAULT '0',
  `ratingsum` int(10) unsigned NOT NULL DEFAULT '0',
  `nfo` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `announce` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `external` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `torrentlang` int(10) unsigned NOT NULL DEFAULT '1',
  `tube` varchar(80) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `language` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT '1',
  `info` text CHARACTER SET latin1,
  `acceptpms` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `ip` varchar(39) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `class` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `avatar` varchar(100) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `uploaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `downloaded` bigint(20) unsigned NOT NULL DEFAULT '0',
  `title` varchar(30) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `donated` int(5) unsigned NOT NULL DEFAULT '0',
  `country` int(10) unsigned NOT NULL DEFAULT '0',
  `notifs` varchar(100) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `enabled` varchar(10) CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `modcomment` text CHARACTER SET latin1,
  `gender` varchar(6) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `client` varchar(25) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `age` int(3) NOT NULL DEFAULT '0',
  `warned` char(3) CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `signature` varchar(200) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `last_browse` int(11) NOT NULL DEFAULT '0',
  `forumbanned` char(3) CHARACTER SET latin1 NOT NULL DEFAULT 'no',
  `invited_by` int(10) NOT NULL DEFAULT '0',
  `invitees` varchar(100) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `invites` smallint(5) NOT NULL DEFAULT '0',
  `invitedate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `commentpm` enum('yes','no') CHARACTER SET latin1 NOT NULL DEFAULT 'yes',
  `passkey` varchar(32) CHARACTER SET latin1 NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `warnings` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `userid` int(10) NOT NULL DEFAULT '0',
  `reason` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
