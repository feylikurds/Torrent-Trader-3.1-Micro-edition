...
<head>
<title>TTv3 Micro Edition Check</title>
...
<body>
<center>
<br /><b>TorrentTrader v3.0/TTv3 Micro Edition Config Check<br /> - TorrentialStorm/MicrosoulV3<br /><br /></b>
...
<p>Disable MYSQL STRICT MODE or you will experience errors. Here is a reference for you <a href='https://www.linode.com/community/questions/17070/how-can-i-disable-mysql-strict-mode' target= "_blank">Click here to follow link</a></p>
<br />
<p>If any of these items are highlighted in red, take note of it and decide if its needed for your requirements.</p>
<br />
This system check is designed for unix based servers, windows based servers may not report correctly<br />
<br />
<br />

<table cellpadding="3" cellspacing="1" style="border-collapse: collapse" border="1">
<tr>
	<td>PHP version >= 7.2.0. DO NOT use php 8, this isnt tested on that</td>
	<td>
	<?php
		echo phpversion() < '7.2' ? '<b><font color="red">No</font></b>' : '<b><font color="green">Yes</font></b>';
...
<tr>
	<td>backend/config.php (chmod 600)</td>
	<td>
	<?php
...
<p>In order for this shit to function correctly it needs to be able to access or write to certain files or directories.<br />
If you see "Unwriteable" you need to change the permissions on the file or directory to 777 (directories) or 666 (files) so that TT can write to it.
<br />The censor.txt should be chmodded to <b>600</b> and be <b><font color="red">Unwriteable</font></b>.
</p>
<br />
...
writableCell( 'cache/diskcache/queries' );
writableCell( 'cache/diskcache/imdb' );
writableCell( 'import' );
