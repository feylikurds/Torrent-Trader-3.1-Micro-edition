...
if($_POST["addnew"] && @count($_POST["addnew"])){
...
// == permanent delete
if($_POST["deletepermanent"] && @count($_POST["deletepermanent"])){
...
if ($_REQUEST["edit"] == "true")
{
	...
	if($_POST["delete"] && @count($_POST["delete"])){
...
if($infolder){
	...
	print("<tr>".
				"<td colspan=\"5\" class=\"table_head\" align=\"center\"><input type=\"submit\" name=\"submit\" class=\"btn\" value=\"".T_("_BTN_DOIT_")."\" />&nbsp;<input type=\"reset\" class=\"btn\" value=\"".T_("_BTN_RESET_")."\" /></td>".
			"</tr>".
			"</table>".
		"</form></td></tr></table>");
...
print("<form enctype=\"multipart/form-data\"  action=\"blocks-edit.php#upload\" method=\"post\" >".
		...
		"<table class=\"table_table\" cellspacing=\"1\" align=\"center\" width=\"100%\">".
			...
			"<tr>".
				...
				"<td class=\"table_col2\" valign=\"top\"><input type=\"file\" name=\"blockupl\" style=\"border: 1px solid #d0d0d0; background-color: white;\" /></td>".
			"</tr>".
		"</table><br />".
"<div id=\"pos\">".
"<table class=\"table_table\" cellspacing=\"0\" align=\"center\" width=\"100%\">".
  ...
  "</tr>".
  "<tr>".
    "<td align=\"center\" class=\"table_col1\">[".T_("_L_")."]</td>".
